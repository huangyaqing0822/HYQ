...
public class Pager<T> {
	...
	public void setSumCount(int sumCount) { //
		...
		//this.sumPage = (int) Math.ceil(this.sumCount/(double)this.sumPage);
		this.sumPage = this.sumCount % pageSize == 0 ? this.sumCount / this.pageSize : this.sumCount / this.pageSize + 1;
