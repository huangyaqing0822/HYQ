...
<body>
	<div style="margin: 10px;10px">
		合同管理>>合同创建<br> 合同名称： <input type="text" class="textbox"
			id="envhetonname" name="contractName" style="width: 110px">
		合同类型： <input id="envhttyp" class="easyui-combobox" name="dept"
			data-options="url:'http://localhost:8080/CrmSystem/contract/contractType',valueField: 'id',
		textField: 'value'" />
		</select>合同状态： <input id="envhtstate" class="easyui-combobox" name="dept"
		...
		<div>
			<span>合同信息列表 </span> <span style="margin-left: 850px"> <a
				href="javascript:examineandverify()" class="easyui-linkbutton"
				iconCls="icon-ok" plain="true">审核</a><a href="#"
				class="easyui-linkbutton" iconCls="icon-search" plain="true"
				onclick="select('查看合同');">查看</a>
			</span>
		</div>
		<table id="envcontractcc"></table>
		...
		<div id="evncontractUpdate" style="display: none" class="wins">
			<div style="margin: 50px 250px">
					...
					<table style="width: 600px; height: 800px">
						<tr>
							...
							<td><input type="text" style="width: 200px; height: 20px"
								name="name" /> <input type="hidden" name="id"></td>
						</tr>
						<tr>
							<td><label for="email">合同类型:</label></td>
							<td><input id="cccs" style="width: 100px; height: 20px"
			...
			<div style="margin: 50px 250px">
				<form id="ces" method="post">
					<table style="width: 600px; height: 800px">
						...
						<tr>
							<td><label for="name">审批意见:</label></td>
							<td><input name="examine" style="width: 400px; height: 150px"></td>
						</tr>
						<tr>
							<td>
								</td>
								<td><a id="tg" style="display: none" href="javascript:examine(1)" class="easyui-linkbutton"
								iconCls="icon-search">通过</a><a id="dh" style="display: none" href="javascript:examine(2)"
								class="easyui-linkbutton" iconCls="icon-search">打回</a> <a
	...
	<script type="text/javascript"
		src="<%=request.getContextPath()%>/scripts/examineAndVerify.js"></script>
</body>
</html>