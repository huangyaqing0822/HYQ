...
<body>
	<div style="margin: 10px;10px">
		服务管理>>服务处理<br> 服务名称： <input type="text" class="textbox"
			name="likeName3" style="width: 110px"> 类型： <input
			name="likeType3" class="easyui-combobox"
		...
		状态： <input name="likeState3" class="easyui-combobox"
			style="width: 100px; height: 20px"
		...
		<div>
			<span>服务信息列表 </span> <span style="margin-left: 850px"> <a
				...
				onclick="handle();">处理</a> <a href="#" class="easyui-linkbutton"
				iconCls="icon-search" plain="true" onclick="select();">查看</a>
			</span>
		</div>

		<table id="manager3"></table>
		...
		<div id="Handle" style="display: none">
			<div style="margin: 20px 50px">
				<table style="line-height: 30px; font-size: 18px; width: 510px">
					...
					<tr>
						<td colspan="2"> 处理结果： <select id="dataValue"
							class="easyui-combobox" name="dataValue" style="width: 100px;" data-options="panelHeight:'50px'">
								<option value="38">已处理</option>
								<option value="62" selected="selected">未处理</option>
								</select>
						</td>
					</tr>
					<tr>
						<td colspan="2"> 处理说明：
						<input name="serveRemark" class="easyui-textbox"
		...
		<div id="lookHandle" style="display: none">
			<div style="margin: 50px 150px">
				<form id="selectHandle" method="post">
					<table>
						<tr>
	...
	<script type="text/javascript"
		src="<%=request.getContextPath()%>/scripts/ServeHandle.js"></script>
</body>
</html>