...
<body>
	<h4 style="text-indent: 25px;">客户管理>>客户关怀管理>>关怀详情</h4> 	
	<div id="love_look">
 	...
 	<table id="loveDetails"></table>
 	
 	<form id="loveDetails_add" style = "padding-left: 70px;padding-top: 20px">
			<table id="xh_table" style="padding-left: 40px;padding-top: 10px">
				...
				<tr>
					<td>执行时间：</td>
					<td><input type="text" name="clExecutiontime" style="height:20px;padding:0 2px;width:200px;"></td>
				</tr>
				<tr>
					<td>执行方案：</td>
					<td>
					<input type="text" name="clExecutionscheme" id="clExecutionscheme" class="easyui-datebox" 
					 style="height:20px;padding:0 2px;width:70px;"/></td>
				</tr>
				<tr>
					<td>执行结果：</td>									
					<td><input type="text" name="clExecutionresult" id="clExecutionresult" class="easyui-datebox" 
					 style="height:20px;padding:0 2px;width:70px;"/></td>
				</tr>
				<tr>
					<td>备注信息：</td>
					<td><textarea name="clRemarkresult" id="clRemarkresult" style="width:280px;height:110px"></textarea></td>
				</tr>							
			</table>			
		</form>
		...
		<form id="loveDetails_edit" style = "padding-left: 70px;padding-top: 20px">
			<table id="xh_table" style="padding-left: 40px;padding-top: 10px">
				<tr>
					<td><input type="hidden" name="cdId_edit" id="cdId_edit"  /></td>
				</tr>
	...
	<script type="text/javascript" src="<%=request.getContextPath()%>/scripts/loveDetails.js"></script>
</body>
</html>