 	...
 	<hr width="1230px;">
		...
		<form id="satisfied_edit" style = "padding-left: 70px;padding-top: 20px">
			<table style="line-height: 30px;font-size: 14px;width: 510px">
				...
				<tr>
					<td>客户编码：<input type="text" name="clientCoding_edit" disabled="false" style="height:20px;padding:0 2px;width:150px;"></td>
					<td>客户姓名：<input type="text" name="clientName_edit" disabled="false" style="height:20px;padding:0 2px;width:150px;">
					</td>
				</tr>
				<tr>							
					<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;性别：<input type="text" name="clientSex_edit" disabled="false" style="height:20px;padding:0 2px;width:150px;"></td>
					<td>客户类型：<input type="text" name="clientType_edit" disabled="false" style="height:20px;padding:0 2px;width:150px;"></span></td>
				</tr>
				<tr>							
					<td>客户状态：<input type="text" name="clientState_edit" disabled="false" style="height:20px;padding:0 2px;width:150px;"></td>
